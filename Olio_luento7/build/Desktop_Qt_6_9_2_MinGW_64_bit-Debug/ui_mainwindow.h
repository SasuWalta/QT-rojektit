...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton->setGeometry(QRect(120, 40, 121, 61));
        pushButton_2 = new QPushButton(centralwidget);
        pushButton_2->setObjectName("pushButton_2");
        pushButton_2->setGeometry(QRect(120, 110, 121, 61));
        lineEdit = new QLineEdit(centralwidget);
        lineEdit->setObjectName("lineEdit");
        lineEdit->setGeometry(QRect(310, 90, 211, 28));
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "Viikkoteht counter", nullptr));
